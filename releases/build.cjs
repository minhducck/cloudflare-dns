...
var CONFIGURATION = import_dotenv.default.config({ override: true }).parsed;
...
// src/constant.js
var CLI_SUCCESS_CODE = 0;
var CLI_CLOUDFLARE_ACCESS_KEY_ERROR_CODE = 1;
var CLI_WAN_IP_CHECK_ERROR_CODE = 2;

// src/api/cloudflare/verify-cf-token.js
var verifyCFToken = async (cloudFlareClient2) => {
  try {
    return await cloudFlareClient2.get("/user/tokens/verify").then((rs) => rs.data);
  } catch (e) {
...
// src/api/ifconfig.me/get-wan-ip.js
var getWANIP = async (client) => {
  try {
...
// src/api/cloudflare/list-all-dns-record.js
var listAllDnsRecord = async (client, zone) => {
  return client.get(`zones/${zone}/dns_records`).then((rs) => rs?.data?.result);
};

// src/api/cloudflare/create-dns-record.js
async function createDnsRecord(client, zone, record, recordType, ip) {
...
// src/api/cloudflare/update-cf-dns-record.js
var isIPV4 = (s) => /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$/.test(s);
var isIPV6 = (s) => /(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))/.test(s);
var updateCloudFlareDNSRecord = async (client, zone, record, ip) => {
...
// src/index.js
var wanIPClient = createClient({
  baseURL: CONFIGURATION["CHECK_WAN_IP_URL"]
});
var cloudFlareClient = createClient({
